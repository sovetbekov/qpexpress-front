...
export default function Layout({children, params: {language}}: Props) {
    ...
    const showMenu = !!pathname && (pathname.match('/(ru|en|zh)/profile/(edit|addresses|orders)$') || pathname.match('/(ru|en|zh)/profile$'))
    const showMobileMenu = !!pathname && pathname.match('/(ru|en|zh)/profile$')
